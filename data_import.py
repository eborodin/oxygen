...
with open('/focal_system_env/tests/prod/gap_report_grocery_focal_superstore_101_2024-10-28_2024-10-28_stage.pdf') as pdf:
    production_text = ''
...
with open('/focal_system_env/tests/staging/gap_report_grocery_focal_superstore_101_2024-10-28_2024-10-28_stage.pdf') as pdf:
    staging_text = ''
    for page in pdf.pages:
