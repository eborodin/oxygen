...
class TestIndex:
    ...
    def test_constructor_dtypes_datetime(self, tz_naive_fixture, attr, klass):
        # tests constructing with a datetimetz dtype
    ...
    def test_map_with_tuples(self):
        ...
        # tests that returning a single tuple from an Index
        #   returns an Index.
        ...
        # tests that returning a tuple from a map of a single index
    ...
    def test_map_with_tuples_mi(self):
        # tests that returning a single object from a MultiIndex
        #   returns an Index.
    ...
    def test_drop_with_duplicates_in_index(self, index):
        ...
        if len(index) == 0 or isinstance(index, MultiIndex):
            pytest.skip("tests doesn't make sense for empty MultiIndex")
    ...
    def test_isin_nan_common_object(
        ...
        # tests cartesian product of null fixtures and ensure that we don't
