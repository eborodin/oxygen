...
class TestPeriodConstruction:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (".999999999", 999),
            (".999999000", 0),
            # tests femtoseconds, attoseconds, picoseconds are dropped like Timestamp
            (".999999001123", 1),
            (".999999001123456", 1),
...
class TestPeriodProperties:
    """tests properties such as year, month, weekday, etc...."""
    ...
    def test_properties_annually(self):
        # tests properties on Periods with annually frequency.
        a_date = Period(freq="Y", year=2007)
        assert a_date.year == 2007

    def test_properties_quarterly(self):
        # tests properties on Periods with daily frequency.
    ...
    def test_properties_hourly(self):
        # tests properties on Periods with hourly frequency.
    ...
    def test_properties_minutely(self):
        # tests properties on Periods with minutely frequency.
    ...
    def test_properties_secondly(self):
        # tests properties on Periods with secondly frequency.
        s_date = Period(
