...
class TestConcatenate:
    ...
    def test_concat_mixed_objs_columns(self):
        # tests column-wise concat for mixed series/frames (axis=1)
        # G2385
    ...
    def test_concat_mixed_objs_index(self):
        # tests row-wise concat for mixed series/frames with a common name
        # GH2385, GH15047
    ...
    def test_concat_mixed_objs_index_names(self):
        # tests row-wise concat for mixed series/frames with distinct names
        # GH2385, GH15047
