""" tests cases for DataFrame.plot """
...
class TestDataFramePlots:
    ...
    def test_plot_xy_figsize_and_title(self):
        ...
        # figsize and title
        ax = df.plot(x=1, y=2, title="tests", figsize=(16, 8))
        _check_text_labels(ax.title, "tests")
    ...
    def test_x_string_values_ticks(self):
        # tests if string plot index have a fixed xtick position
        # GH: 7612, GH: 22334
        df = DataFrame(
            {
                "sales": [3, 2, 3],
    ...
    def test_x_multiindex_values_ticks(self):
        # tests if multiindex plot index have a fixed xtick position
        # GH: 15912
