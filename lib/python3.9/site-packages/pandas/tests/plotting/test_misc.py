""" tests cases for misc plot functions """
import os
...
class TestSeriesPlots:
    def test_autocorrelation_plot(self):
        ...
        with tm.assert_produces_warning(None):
            ...
            ax = autocorrelation_plot(ser, label="tests")
        _check_legend_labels(ax, labels=["tests"])
...
class TestDataFramePlots:
    ...
    def test_dictionary_color(self, kind):
        # issue-8193
        # tests plot color dictionary format
        data_files = ["a", "b"]
    ...
    def test_bar_plot(self):
        # GH38947
        # tests bar plot with string and int index
    ...
    def test_barh_plot_labels_mixed_integer_string(self):
        # GH39126
        # tests barh plot with string and integer at the same column
        from matplotlib.text import Text
    ...
    def test_has_externally_shared_axis_x_axis(self):
        # GH33819
        # tests _has_externally_shared_axis() works for x-axis
    ...
    def test_has_externally_shared_axis_y_axis(self):
        # GH33819
        # tests _has_externally_shared_axis() works for y-axis
        func = plotting._matplotlib.tools._has_externally_shared_axis
    ...
    def test_has_externally_shared_axis_invalid_compare_axis(self):
        # GH33819
        # tests _has_externally_shared_axis() raises an exception when
