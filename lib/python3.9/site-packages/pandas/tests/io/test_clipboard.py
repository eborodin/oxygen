...
class TestClipboard:
    # tests that default arguments copy as tab delimited
    # tests that explicit delimiters are respected
    ...
    # tests that multi-character separators are not silently passed
