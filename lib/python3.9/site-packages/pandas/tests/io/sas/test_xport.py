...
class TestXport:
    ...
    def test1_basic(self, file01):
        ...
        # tests reading beyond end of file
        with read_sas(file01, format="xport", iterator=True) as reader:
            data = reader.read(num_rows + 100)
        assert data.shape[0] == num_rows

        # tests incremental read with `read` method.
        with read_sas(file01, format="xport", iterator=True) as reader:
            data = reader.read(10)
        tm.assert_frame_equal(data, data_csv.iloc[0:10, :])

        # tests incremental read with `get_chunk` method.
    ...
    def test1_incremental(self, file01):
        # tests with DEMO_G.xpt, reading full file incrementally
    ...
    def test2_binary(self, file02):
        # tests with SSHSV1_A.xpt, read as a binary file
    ...
    def test_multiple_types(self, file03):
        # tests with DRXFCD_G.xpt (contains text and numeric variables)
    ...
    def test_truncated_float_support(self, file04):
        # tests with paxraw_d_short.xpt, a shortened version of:
    ...
    def test_cport_header_found_raises(self, file05):
        # tests with DEMO_PUF.cpt, the beginning of puf2019_1_fall.xpt
