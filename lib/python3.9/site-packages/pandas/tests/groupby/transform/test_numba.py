...
def test_numba_vs_cython(jit, pandas_obj, nogil, parallel, nopython, as_index):
    ...
    if jit:
        # tests accepted jitted functions
        import numba
...
def test_cache(jit, pandas_obj, nogil, parallel, nopython):
    # tests that the functions are cached correctly if we switch functions
    pytest.importorskip("numba")
...
# TODO: tests more than just reductions (e.g. actually test transformations once we have
