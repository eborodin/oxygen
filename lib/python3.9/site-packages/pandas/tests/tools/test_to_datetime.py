...
class TestToDatetime:
    ...
    def test_to_datetime_today(self, tz):
        # See GH#18666
        # tests with one timezone far ahead of UTC and another far behind, so
...
class TestToDatetimeUnit:
    ...
    def test_unit_str(self, cache):
        # GH 57051
        # tests that strs aren't dropping precision to 32-bit accidentally.
...
class TestDatetimeParsingWrappers:
    ...
    def test_parsers_nat(self):
        # tests that each of several string-accepting methods return pd.NaT
