...
def test_array_and_stringlike_roundtrip(strtype):
    """
    tests that string representations of long-double roundtrip both
    ...
    # tests that `o` is correctly coerced from the string-like
    assert o == np.longdouble(o_str)

    # tests that arrays also roundtrip correctly:
