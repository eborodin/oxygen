...
class TestHalf:
    ...
    def test_half_conversion_rounding(self, float_t, shift, offset):
        ...
        # tests all (positive) finite numbers, denormals are most interesting
        # however:
    ...
    def test_half_conversion_denormal_round_even(self, float_t, uint_t, bits):
        # tests specifically that all bits are considered when deciding
    ...
    def test_spacing_nextafter(self):
        """tests np.spacing and np.nextafter"""
    ...
    def test_half_coercion(self, weak_promotion):
        """tests that half gets coerced properly with the other types"""
    ...
    def test_half_array_interface(self):
        """tests that half is compatible with __array_interface__"""
        class Dummy:
            pass
