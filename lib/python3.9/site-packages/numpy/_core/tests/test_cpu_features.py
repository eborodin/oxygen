...
if __name__ == "__main__":
    ...
    def test_variable_too_long(self, action):
        """
        tests that an error is thrown if the environment variables are too long
    ...
    def test_impossible_feature_disable(self):
        """
        tests that a RuntimeError is thrown if an impossible feature-disabling
    ...
    def test_impossible_feature_enable(self):
        """
        tests that a RuntimeError is thrown if an impossible feature-enabling
