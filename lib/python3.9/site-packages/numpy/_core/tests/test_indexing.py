...
class TestIndexing:
    ...
    def test_reversed_strides_result_allocation(self):
        # tests a bug when calculating the output strides for a result array
    ...
    def test_trivial_fancy_not_possible(self):
        # tests that the fast path for trivial assignment is not incorrectly
    ...
    def test_structured_advanced_indexing(self):
        # tests that copyswap(n) used by integer array indexing is threadsafe
...
class TestSubclasses:
    def test_basic(self):
        # tests that indexing in various ways produces SubClass instances,
    ...
    def test_fancy_on_read_only(self):
        # tests that fancy indexing on read-only SubClass does not make a
