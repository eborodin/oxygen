...
class TestScalarDiscovery:
    ...
    def test_scalar_coercion(self, scalar):
        ...
        # tests various ways to create an array containing this scalar:
...
class TestNested:
    ...
    def test_pathological_self_containing(self):
        # tests that this also works for two nested sequences
        l = []
        l.append(l)
...
class TestArrayLikes:
    ...
    def test_too_large_array_error_paths(self):
        """tests the error paths, including for memory leaks"""
...
class TestAsArray:
    """tests expected behaviors of ``asarray``."""
