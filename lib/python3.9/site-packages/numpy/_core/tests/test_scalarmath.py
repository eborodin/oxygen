...
class TestConversion:
    ...
    @pytest.mark.skipif(not IS_PYPY, reason="tests is PyPy only (gh-9972)")
...
class TestMultiply:
    def test_seq_repeat(self):
        # tests that basic sequences get repeated when multiplied with
    ...
    def test_no_seq_repeat_basic_array_like(self):
        # tests that an array-like which does not know how to be multiplied
        ...
        # tests for simple ArrayLike above and memoryviews (original report)
...
class TestHash:
    ...
    def test_complex_hashes(self, type_code):
        # tests some complex valued hashes specifically:
        scalar = np.dtype(type_code).type
