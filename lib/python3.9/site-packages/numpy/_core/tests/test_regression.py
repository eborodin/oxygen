...
class TestRegression:
    ...
    def test_dot_alignment_sse2(self):
        # tests for ticket #551, changeset r5140
        x = np.zeros((30, 40))
        for proto in range(2, pickle.HIGHEST_PROTOCOL + 1):
    ...
    def test_void_scalar_constructor(self):
        ...
        # tests pickle and unpickle of void and record scalars
        for proto in range(2, pickle.HIGHEST_PROTOCOL + 1):
    ...
    def test_object_array_circular_reference(self):
        # tests the same for a circular reference.
        a = np.array(0, dtype=object)
    ...
    def test_repeated_square_consistency(self):
        ...
        buf = np.array([-5.171866611150749e-07 + 2.5618634555957426e-07j,
                        0, 0, 0, 0, 0])
        # tests buffer with regular and reverse strides
