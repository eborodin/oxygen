...
class TestFloatExceptions:
    ...
    # tests for all real and complex float types
    @pytest.mark.skipif(IS_WASM, reason="no wasm fp exception support")
    ...
    def test_floating_exceptions(self, typecode):
        ...
        # tests basic arithmetic function errors
...
class TestFromiter:
    ...
    def test_2592(self, count, error_index, dtype):
        # tests iteration exceptions are correctly raised. The data/generator
...
class TestNonzero:
    ...
    def test_nonzero_exception_safe(self):
        ...
        """
        tests that a ValueError is raised instead of a SystemError
...
class TestClip:
    ...
    def test_simple_double(self):
        # tests native double input with scalar min/max.
    ...
    def test_simple_int(self):
        # tests native int input with scalar min/max.
    ...
    def test_array_double(self):
        # tests native double input with array min/max.
        a = self._generate_data(self.nr, self.nc)
        m = np.zeros(a.shape)
        M = m + 0.5
        ac = self.fastclip(a, m, M)
    ...
    def test_simple_nonnative(self):
        # tests non native double input with scalar min/max.
        # tests native double input with non native double scalar min/max.
    ...
    def test_simple_complex(self):
        # tests native complex input with native double scalar min/max.
        # tests native input with complex double scalar min/max.
    ...
    def test_clip_complex(self):
        ...
        # tests native complex input without explicit min/max
    ...
    def test_clip_non_contig(self):
        # tests clip for non contiguous native input and native scalar min/max.
    ...
    def test_simple_int32_inout(self, casting):
        # tests native int32 input with double min/max and int32 out.
    ...
    def test_simple_int64_out(self):
        # tests native int32 input with int32 scalar min/max and int64 out.
        a = self._generate_int32_data(self.nr, self.nc)
        m = np.int32(-1)
        M = np.int32(1)
    ...
    def test_simple_int64_inout(self):
        # tests native int32 input with double array min/max and int32 out.
        a = self._generate_int32_data(self.nr, self.nc)
    ...
    def test_simple_int32_out(self):
        # tests native double input with scalar min/max and int out.
        a = self._generate_data(self.nr, self.nc)
        m = -1.0
        M = 2.0
        ac = np.zeros(a.shape, dtype=np.int32)
    ...
    def test_simple_inplace_01(self):
        # tests native double input with array min/max in-place.
        a = self._generate_data(self.nr, self.nc)
        ac = a.copy()
        m = np.zeros(a.shape)
        M = 1.0
    ...
    def test_simple_inplace_02(self):
        # tests native double input with scalar min/max in-place.
        a = self._generate_data(self.nr, self.nc)
        ac = a.copy()
        m = -0.5
        M = 0.6
    ...
    def test_noncontig_inplace(self):
        # tests non contiguous double input with double scalar min/max in-place.
        a = self._generate_data(self.nr * 2, self.nc * 3)
        a = a[::2, ::3]
        assert_(not a.flags['F_CONTIGUOUS'])
        assert_(not a.flags['C_CONTIGUOUS'])
    ...
    def test_type_cast_02(self):
        # tests native int32 input with int32 scalar min/max.
        a = self._generate_int_data(self.nr, self.nc)
        a = a.astype(np.int32)
        m = -2
        M = 4
    ...
    def test_type_cast_03(self):
        # tests native int32 input with float64 scalar min/max.
        a = self._generate_int32_data(self.nr, self.nc)
        m = -2
        M = 4
    ...
    def test_type_cast_04(self):
        # tests native int32 input with float32 scalar min/max.
        a = self._generate_int32_data(self.nr, self.nc)
        m = np.float32(-2)
        M = np.float32(4)
    ...
    def test_type_cast_05(self):
        # tests native int32 with double arrays min/max.
        a = self._generate_int_data(self.nr, self.nc)
        m = -0.5
        M = 1.
    ...
    def test_type_cast_06(self):
        # tests native with NON native scalar min/max.
        a = self._generate_data(self.nr, self.nc)
        m = 0.5
    ...
    def test_type_cast_07(self):
        # tests NON native with native array min/max.
        a = self._generate_data(self.nr, self.nc)
    ...
    def test_type_cast_08(self):
        # tests NON native with native scalar min/max.
        a = self._generate_data(self.nr, self.nc)
        m = -0.5
        M = 1.
        a_s = self._neg_byteorder(a)
    ...
    def test_type_cast_09(self):
        # tests native with NON native array min/max.
        a = self._generate_data(self.nr, self.nc)
        m = -0.5 * np.ones(a.shape)
        M = 1.
        m_s = self._neg_byteorder(m)
    ...
    def test_type_cast_10(self):
        # tests native int32 with float min/max and float out for output argument.
        a = self._generate_int_data(self.nr, self.nc)
    ...
    def test_type_cast_11(self):
        # tests non native with native scalar, min/max, out non native
        a = self._generate_non_native_data(self.nr, self.nc)
        b = a.copy()
    ...
    def test_type_cast_12(self):
        # tests native int32 input and min/max and float out
        a = self._generate_int_data(self.nr, self.nc)
        b = np.zeros(a.shape, dtype=np.float32)
        m = np.int32(0)
        M = np.int32(1)
    ...
    def test_clip_with_out_transposed(self):
        # tests that the out argument works when transposed
    ...
    def test_clip_with_out_memory_overlap(self):
        # tests that the out argument works when it has memory overlap
        a = np.arange(16).reshape(4, 4)
        ac = a.copy()
...
class TestIsclose:
    ...
    def test_nep50_isclose(self):
        ...
        # tests that it works for isclose arguments too (and that those fail if
...
class TestCreationFuncs:
    # tests ones, zeros, empty and full.
...
class TestLikeFuncs:
    '''tests ones_like, zeros_like, empty_like and full_like'''
...
class TestTensordot:
    ...
    def test_zero_dimension(self):
        # tests resolution to issue #5663
        a = np.ndarray((3,0))
        b = np.ndarray((0,4))
