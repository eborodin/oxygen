...
class TestDateTime:
    ...
    def test_time_byteswapped_cast(self, time1, time2):
        ...
        # tests that every byte-swapping combination also returns the same
    ...
    def test_datetime_compare(self):
        # tests all the comparison operators
    ...
    def test_datetime_y2038(self):
        msg = "no explicit representation of timezones available for " \
              "np.datetime64"
        # tests parsing on either side of the Y2038 boundary
        ...
        # tests parsing on either side of the Y2038 boundary with
        ...
        # tests parsing a date after Y2038
    ...
    def test_isnat_error(self):
        # tests that only datetime dtype arrays are accepted
