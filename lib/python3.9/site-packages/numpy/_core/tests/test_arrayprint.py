...
class TestArray2String:
    ...
    def test_format_function(self):
        """tests custom format function for each element in array."""
...
class TestPrintOptions:
    """tests getting and setting global print options."""
...
def test_scalar_repr_numbers(dtype, value):
    # tests NEP 51 scalar repr (and legacy option) for numeric types
