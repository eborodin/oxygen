...
def test_nep50_integer_regression():
    # tests the old integer promotion rules.  When the integer is too large,
...
def test_integer_comparison(sctype, other_val, comp):
    ...
    # tests that comparisons with integers (especially out-of-bound) ones
    # works correctly.
    val_obj = 10
    val = sctype(val_obj)
...
def test_integer_integer_comparison(comp):
    ...
    # tests that the NumPy comparison ufuncs work with large Python integers
