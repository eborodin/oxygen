...
class TestNdpointerCFunc:
    def test_arguments(self):
        """ tests that arguments are coerced from arrays """
    ...
    def test_return(self, dt):
        """ tests that return values are coerced to arrays """
        arr = np.zeros((2, 3), dt)
    ...
    def test_vague_return_value(self):
        """ tests that vague ndpointer return values do not promote to arrays """
        arr = np.zeros((2, 3))
...
class TestAsCtypesType:
    """ tests conversion from dtypes to ctypes types """
