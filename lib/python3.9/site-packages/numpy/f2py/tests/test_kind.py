...
class TestKind(util.F2PyTest):
    ...
    def test_int(self):
        """tests `int` kind_func for integers up to 10**40."""
    ...
    def test_real(self):
        """
        tests (processor-dependent) `real` kind_func for real numbers
    ...
    def test_quad_precision(self):
        """
        tests kind_func for quadruple precision [`real(16)`] of 32+ digits .
        """
        selectedrealkind = self.module.selectedrealkind
