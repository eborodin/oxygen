...
class TestMiscCharacter(util.F2PyTest):
    ...
    def test_gh18684(self):
        # tests character(len=5) and character*5 usages
    ...
    def test_gh6308(self):
        # tests character string array in a common block
    ...
    def test_gh4519(self):
        # tests array of assumed length strings
    ...
    def test_gh3425(self):
        # tests returning a copy of assumed length string
