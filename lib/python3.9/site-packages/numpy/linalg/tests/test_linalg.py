""" tests functions for linalg module
...
#
# tests different routines against the above cases
#
...
class TestSolve(SolveCases):
    ...
    def test_0_size(self):
        ...
        # tests errors for non-square and only b's dimension being 0
        assert_raises(linalg.LinAlgError, linalg.solve, a[:, 0:0, 0:1], b)
        assert_raises(ValueError, linalg.solve, a, b[:, 0:0, :])

        # tests broadcasting error
        b = np.arange(6).reshape(1, 3, 2)  # broadcasting error
        assert_raises(ValueError, linalg.solve, a, b)
        assert_raises(ValueError, linalg.solve, a[0:0], b[0:0])

        # tests zero "single equations" with 0x0 matrices.
        b = np.arange(2).view(ArraySubclass)
        expected = linalg.solve(a, b)[:, 0:0]
        result = linalg.solve(a[:, 0:0, 0:0], b[0:0])
        assert_array_equal(result, expected)
...
def test_reduced_rank():
    # tests matrices with reduced rank
...
class TestMultiDot:
    ...
    def test_dynamic_programming_logic(self):
        # tests for the dynamic programming part
