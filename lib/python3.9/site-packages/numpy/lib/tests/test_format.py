...
tests the magic string writing.
...
tests the magic string reading.
...
def test_pickle_python2_python3():
    # tests that loading object arrays saved on Python 2 works both on
