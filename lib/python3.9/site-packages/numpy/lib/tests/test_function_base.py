...
class TestDelete:
    ...
    def test_single_item_array_non_int(self):
        ...
        # tests the more complicated (with axis) case from gh-21840
        x = np.ones((3, 1))
...
class TestVectorize:
    ...
    def test_keywords2_ticket_2100(self):
        # tests kwarg support: enhancement ticket 2100
    ...
    def test_keywords3_ticket_2100(self):
        # tests excluded with mixed positional and kwargs: ticket 2100
        def mypolyval(x, p):
            _p = list(p)
            res = _p.pop(0)
            while _p:
    ...
    def test_keywords4_ticket_2100(self):
        # tests vectorizing function with no positional args.
        @vectorize
        def f(**kw):
            res = 1.0
            for _k in kw:
    ...
    def test_keywords5_ticket_2100(self):
        # tests vectorizing function with no kwargs args.
        @vectorize
        def f(*v):
            return np.prod(v)
    ...
    def test_string_ticket_1892(self):
        # tests vectorization over strings: issue 1892.
...
class TestMeshgrid:
    ...
    def test_invalid_arguments(self):
        # tests that meshgrid complains about invalid arguments
    ...
    def test_return_type(self):
        # tests for appropriate dtype in returned arrays.
...
class TestBincount:
    ...
    def test_error_not_1d(self, vals):
        # tests that values has to be 1-D (both as array and nested list)
...
class TestInterp:
    ...
    def test_non_finite_inf(self, sc):
        """ tests that interp between opposite infs gives nan """
    ...
    def test_non_finite_half_inf_xf(self, sc):
        """ tests that interp where both axes have a bound at inf gives nan """
    ...
    def test_non_finite_half_inf_x(self, sc):
        """ tests interp where the x axis has a bound at inf """
    ...
    def test_non_finite_half_inf_f(self, sc):
        """ tests interp where the f axis has a bound at inf """
...
class TestQuantile:
    ...
    def test_quantile_identification_equation(self, weights, method, alpha):
        # tests that the identification equation holds for the empirical
        # CDF:
