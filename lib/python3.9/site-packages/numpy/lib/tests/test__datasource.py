...
class TestDataSourceOpen:
    ...
    def test_ValidGzipFile(self):
        try:
            ...
            pytest.skip()
        # tests datasource's internal file_opener for Gzip files.
    ...
    def test_ValidBz2File(self):
        try:
            ...
            pytest.skip()
        # tests datasource's internal file_opener for BZip2 files.
...
class TestDataSourceExists:
    ...
    def test_ValidFile(self):
        # tests valid file in destpath
        tmpfile = valid_textfile(self.tmpdir)
        assert_(self.ds.exists(tmpfile))
        # tests valid local file not in destpath
        localdir = mkdtemp()
...
class TestDataSourceAbspath:
    ...
    def test_ValidFile(self):
        ...
        # tests with filename only
        assert_equal(tmpfile, self.ds.abspath(tmpfilename))
        # tests filename with complete path
...
class TestOpenFunc:
    ...
    def test_DataSourceOpen(self):
        local_file = valid_textfile(self.tmpdir)
        # tests case where destpath is passed in
        fp = datasource.open(local_file, destpath=self.tmpdir)
        assert_(fp)
        fp.close()
        # tests case where default destpath is used
