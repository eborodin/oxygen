"""tests functions for 1D array set operations.
...
class TestSetOps:
    ...
    def test_isin_boolean(self, kind):
        """tests that isin works for boolean input"""
    ...
    def test_isin_timedelta(self, kind):
        """tests that isin works for timedelta input"""
    ...
    def test_isin_mixed_dtype(self, dtype1, dtype2, kind):
        """tests that isin works as expected for mixed dtype input."""
    ...
    def test_isin_mixed_huge_vals(self, kind, data):
        """tests values outside intp range (negative ones if 32bit system)"""
        query = data[1]
    ...
    def test_isin_mixed_boolean(self, kind):
        """tests that isin works as expected for bool/int input."""
    ...
    def test_isin_both_arrays_have_structured_dtype(self):
        # tests arrays of a structured data type containing an integer field
    ...
    def test_isin_errors(self):
        """tests that isin raises expected errors."""
