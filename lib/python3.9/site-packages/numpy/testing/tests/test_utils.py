...
class _GenericTest:
    ...
    def test_array_rank1_eq(self):
        """tests two equal array of rank 1 are found equal."""
        a = np.array([1, 2])
        b = np.array([1, 2])
    ...
    def test_array_rank1_noteq(self):
        """tests two different array of rank 1 are found not equal."""
        a = np.array([1, 2])
        b = np.array([2, 2])
    ...
    def test_array_rank2_eq(self):
        """tests two equal array of rank 2 are found equal."""
        a = np.array([[1, 2], [3, 4]])
        b = np.array([[1, 2], [3, 4]])
    ...
    def test_array_diffshape(self):
        """tests two arrays with different shapes are found not equal."""
        a = np.array([1, 2])
        b = np.array([[1, 2], [1, 2]])
...
class TestArrayEqual(_GenericTest):
    ...
    def test_generic_rank1(self):
        """tests rank 1 array for all dtypes."""
        def foo(t):
            a = np.empty(2, t)
            a.fill(1)
            b = a.copy()
        ...
        # tests numeric types and object
    ...
    def test_generic_rank3(self):
        """tests rank 3 array for all dtypes."""
        def foo(t):
            a = np.empty((4, 2, 3), t)
            a.fill(1)
            b = a.copy()
    ...
    def test_nan_array(self):
        """tests arrays with nan values in them."""
    ...
    def test_array_vs_scalar_is_equal(self):
        """tests comparing an array with a scalar when all values are equal."""
        a = np.array([1., 1., 1.])
        b = 1.
    ...
    def test_array_vs_array_not_equal(self):
        """tests comparing an array with a scalar when not all values equal."""
    ...
    def test_array_vs_scalar_strict(self):
        """tests comparing an array with a scalar with strict option."""
        a = np.array([1., 1., 1.])
        b = 1.
    ...
    def test_array_vs_array_strict(self):
        """tests comparing two arrays with strict option."""
        a = np.array([1., 1., 1.])
        b = np.array([1., 1., 1.])
...
class TestArrayAlmostEqual(_GenericTest):
    ...
    def test_subclass(self):
        ...
        # tests fully masked as well (see gh-11123).
...
class TestAlmostEqual(_GenericTest):
    ...
    def test_error_message(self):
        ...
        # tests with a different amount of decimal digits
...
class TestArrayAssertLess:
    ...
    def test_strict(self):
        """tests the behavior of the `strict` option."""
        x = np.zeros(3)
        y = np.ones(())
        self._assert_func(x, y)
        with pytest.raises(AssertionError):
...
class TestULP:
    ...
    def test_nan(self):
        # tests that nan is 'far' from small, tiny, inf, max and min
        for dt in [np.float32, np.float64]:
            if dt == np.float32:
                maxulp = 1e6
            else:
...
def test_suppress_warnings_module():
    ...
    # tests module based warning suppression:
    assert_warn_len_equal(my_mod, 0)
...
def test_clear_and_catch_warnings_inherit():
    # tests can subclass and add default modules
    my_mod = _get_fresh_mod()
    with my_cacw():
        warnings.simplefilter('ignore')
        warnings.warn('Some warning')
...
class TestAssertNoGcCycles:
    ...
    def test_fails(self):
        """
        tests that in cases where the garbage cannot be collected, we raise an
...
def test_xy_rename(assert_func):
    # tests that keywords `x` and `y` have been renamed to `actual` and
