...
def print_assert_equal(test_string, actual, desired):
    """
    tests if two objects are equal, and print an error message if test fails.
    ...
    Examples
    --------
    >>> np.testing.print_assert_equal('tests XYZ of func xyz', [0, 1], [0, 1])
    >>> np.testing.print_assert_equal('tests XYZ of func xyz', [0, 1], [0, 2])
    Traceback (most recent call last):
    ...
    AssertionError: tests XYZ of func xyz failed
    ACTUAL:
    [0, 1]
    DESIRED:
    [0, 2]
...
def measure(code_str, times=1, label=None):
    ...
    code = compile(code_str, f'tests name: {label} ', 'exec')
    i = 0
    elapsed = jiffies()
    while i < times:
        i += 1
