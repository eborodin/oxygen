...
class TestSubclassing:
    # tests suite for masked subclasses of ndarray.
    ...
    def test_attributepropagation(self):
        ...
        # tests that inplace methods from data get used (gh-4617)
        ym += 1
    ...
    def test_pure_subclass_info_preservation(self):
        # tests that ufuncs and methods conserve extra information consistently;
        # see gh-7122.
...
def test_array_no_inheritance():
    ...
    assert_equal(data_masked.data, new_array.data)
    assert_equal(data_masked.mask, new_array.mask)
    # tests that the mask is not shared when copy=True
    ...
    # tests that the mask is False and not shared when keep_mask=False
    assert_(not new_array.mask)
    assert_(not new_array.sharedmask)


class TestClassWrapping:
    # tests suite for classes that wrap MaskedArrays
    ...
    def test_masked_binary_operations(self):
        ...
        # tests domained binary operations
