"""tests inter-conversion of different polynomial classes.
...
#
# tests conversion methods that depend on combinations of two classes.
#
...
#
# tests class method that only exists for some classes
#
