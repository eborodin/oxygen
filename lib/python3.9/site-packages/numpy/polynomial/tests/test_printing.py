...
def test_complex_coefficients():
    """tests both numpy and built-in complex."""
...
def test_nonnumeric_object_coefficients(coefs, tgt):
    """
    tests coef fallback for object arrays of non-numeric coefficients.
    """
    p = poly.Polynomial(coefs)
    poly.set_default_printstyle('unicode')
    assert_equal(str(p), tgt)
...
class TestLatexRepr:
    """tests the latex repr used by Jupyter"""
...
class TestPrintOptions:
    """
    tests the output is properly configured via printoptions.
